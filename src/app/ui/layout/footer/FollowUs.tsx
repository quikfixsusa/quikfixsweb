  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex gap-3">
        <ButtonSocialMedia icon={<Facebook size={28} color="#000" />} url="https://facebook.com/@quikfixs" />
        <ButtonSocialMedia icon={<Instagram size={28} color="#000" />} url="https://instagram.com/quikfixs" />
        <ButtonSocialMedia icon={<TikTok size={28} color="#000" />} url="https://tiktok.com/@quikfixs" />
        <ButtonSocialMedia icon={<Youtube size={28} color="#000" />} url="https://youtube.com/@quikfixs" />
      </div>
    </div>
  );
}
